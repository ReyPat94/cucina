...
<hr>
<br>
						<form action='/aggiungiEdizione' method='get'> <!-- PATH CORRETTO -->
							<div>
								<label for='idCorso'> ID Corso </label> <input id='usrn'
							...
							<div>
								<label for='durata'> Durata </label> <input id='usrn'
							...
							<div>
								...
								<button type="submit" class="button">Aggiungi Edizione</button>
						</form>
<br><br>
